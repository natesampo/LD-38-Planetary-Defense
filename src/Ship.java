...
public class Ship extends GameObject {
	...
	public Ship(int x, int y, int velX, int velY, int shipnum, ID id) {
		...
		shipStats.get(0).put("image",  "C:/Users/Nate/Desktop/Eclipse Workspace/ASmallWorld/Ship1.png");
		...
		shipStats.get(1).put("image",  "C:/Users/Nate/Desktop/Eclipse Workspace/ASmallWorld/Ship2.png");
		...
		shipStats.get(2).put("image",  "C:/Users/Nate/Desktop/Eclipse Workspace/ASmallWorld/Ship3.png");
		...
		shipStats.get(3).put("image",  "C:/Users/Nate/Desktop/Eclipse Workspace/ASmallWorld/Ship4.png");
		shipStats.get(3).put("hp",  "10");
		shipStats.get(3).put("speed",  "10");
		shipStats.get(3).put("strategy",  "0");
		shipStats.get(3).put("damage",  "10");
